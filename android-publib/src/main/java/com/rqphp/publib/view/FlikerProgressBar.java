...
public class FlikerProgressBar extends View implements Runnable {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            textSize = (int) typedArray.getDimension(R.styleable.FlikerProgressBar_textSize, 14);
            loadingColor = typedArray.getColor(R.styleable.FlikerProgressBar_loadingColor, Color.parseColor("#40c4ff"));
            pauseColor = typedArray.getColor(R.styleable.FlikerProgressBar_pauseColor, Color.parseColor("#ff9800"));
            ...
            isShowText = typedArray.getBoolean(R.styleable.FlikerProgressBar_isShowText, false);
        } finally {
            typedArray.recycle();
        }
    }
    ...
    public void setTextShow(boolean isShowText){
    ...
    public void run() {
        ...
        try {
            while (!isPause && !thread.isInterrupted()) {
                flickerLeft += dp2px(5);
                float progressWidth = (progress / maxProgress) * getMeasuredWidth();
