...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
     ...
     * 滚轮滑动时的最小/最大速度
     */
    private int mMinimumVelocity = 30, mMaximumVelocity = 5000;
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        mItemTextSize = a.getDimensionPixelSize(R.styleable.WheelPicker_wheel_item_text_size, getResources().getDimensionPixelSize(R.dimen.dimen_15sp));
        ...
        mItemSpace = a.getDimensionPixelSize(R.styleable.WheelPicker_wheel_item_space, getResources().getDimensionPixelSize(R.dimen.dimen_30dp));
        ...
        mIndicatorSize = a.getDimensionPixelSize(R.styleable.WheelPicker_wheel_indicator_size, getResources().getDimensionPixelSize(R.dimen.dimen_1dp));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int drawnDataPos = drawnDataStartPos + mSelectedItemPosition, drawnOffsetPos = -mHalfDrawnItemCount; drawnDataPos < drawnDataStartPos + mSelectedItemPosition + mDrawnItemCount;
            ...
            if (mSelectedItemTextColor != -1) {
                ...
                StaticLayout staticLayout1 = new StaticLayout(data, mPaint, getWidth(), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
                canvas.translate(mDrawnCenterX, drawnCenterY - (mItemHeight + mItemSpace / 3) / 2);
                ...
                //                canvas.drawText(data, mDrawnCenterX, drawnCenterY, mPaint);
                StaticLayout staticLayout = new StaticLayout(data, mPaint, getWidth(), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
                canvas.translate(mDrawnCenterX, drawnCenterY - (mItemHeight + mItemSpace / 3) / 2);
